...
3. **验证结果**：
   ...
   - `.opencode/commands/` 下含 goal-d.md、goal-o.md、goal-init.md、goal-tl.md、goal-tr.md
...
5. **告知用户**：重启 opencode / Reasonix 后即可使用 `/goal-develop`、`/goal-deliver`、`/goal-init`、`/goal-tasks`、`/goal-testresults` 与 19 个 subagent（opencode 用 `@<agent名>`，Reasonix 用 `/<agent名> <任务>`）。
